...
function proc_appendage_latentability(appendage)
{
	...
	{
		local skillLevel = sqrChr.sq_GetSkillLevel(70);
		local value0 = sq_GetLevelData(sqrChr, 70, 0, skillLevel); //ÕôÕá%
		local value1 = sq_GetLevelData(sqrChr, 70, 1, skillLevel); //òªÕô%
		local value2 = sq_GetLevelData(sqrChr, 70, 2, skillLevel); //ô÷Õô%
		local value3 = sq_GetLevelData(sqrChr, 70, 3, skillLevel); //ïñãê%

		local value4 = sq_GetLevelData(sqrChr, 70, 4, skillLevel); //ÕôÕá
		local value5 = sq_GetLevelData(sqrChr, 70, 5, skillLevel); //òªÕô
		local value6 = sq_GetLevelData(sqrChr, 70, 6, skillLevel); //ô÷Õô
		local value7 = sq_GetLevelData(sqrChr, 70, 7, skillLevel); //ïñãê

		local value8 = sq_GetLevelData(sqrChr, 70, 8, skillLevel); //Úª×âÍôÌªÕô%
		local value9 = sq_GetLevelData(sqrChr, 70, 9, skillLevel); //ØªÛöÍôÌªÕô%
		local value10 = sq_GetLevelData(sqrChr, 70, 10, skillLevel); //Ô¼Ø¡ÍôÌªÕô%
		local value11 = sq_GetLevelData(sqrChr, 70, 11, skillLevel); //Ô¼Ø¡ÍôÌªÕô%

		local value12 = sq_GetLevelData(sqrChr, 70, 12, skillLevel); //Úª×âÍôÌªÕô
		local value13 = sq_GetLevelData(sqrChr, 70, 13, skillLevel); //ØªÛöÍôÌªÕô
		local value14 = sq_GetLevelData(sqrChr, 70, 14, skillLevel); //Ô¼Ø¡ÍôÌªÕô
		local value15 = sq_GetLevelData(sqrChr, 70, 15, skillLevel); //Ô¼Ø¡ÍôÌªÕô

		local value16 = sq_GetLevelData(sqrChr, 70, 16, skillLevel); //ÍôÌªáÜÓø
		local value17 = sq_GetLevelData(sqrChr, 70, 17, skillLevel); //ì¹ÔÑáÜÓø
		local value18 = sq_GetLevelData(sqrChr, 70, 18, skillLevel); //à·Û¯áÜÓø

		local value19 = sq_GetLevelData(sqrChr, 70, 19, skillLevel); //Úª×âøìÌªáã
		local value20 = sq_GetLevelData(sqrChr, 70, 20, skillLevel); //ØªÛöøìÌªáã

		local value21 = sq_GetLevelData(sqrChr, 70, 21, skillLevel); //ûıq
		local value22 = sq_GetLevelData(sqrChr, 70, 22, skillLevel); //?q
		local value23 = sq_GetLevelData(sqrChr, 70, 23, skillLevel); //äŞq
		local value24 = sq_GetLevelData(sqrChr, 70, 24, skillLevel); //ÎÃq
		local value25 = sq_GetLevelData(sqrChr, 70, 25, skillLevel); //á¶êóáÕq

		local value26 = sq_GetLevelData(sqrChr, 70, 26, skillLevel); //CD

		local value27 = sq_GetLevelData(sqrChr, 70, 27, skillLevel); //Úª×âøìÌªß¿úª
		local value28 = sq_GetLevelData(sqrChr, 70, 28, skillLevel); //ØªÛöøìÌªß¿úª
		...
		if(change_appendage)
		{
			...
			change_appendage.addParameter(CHANGE_STATUS_TYPE_ELEMENT_ATTACK_FIRE, false, value21.tofloat()); //ûıq
			change_appendage.addParameter(CHANGE_STATUS_TYPE_ELEMENT_ATTACK_WATER, false, value22.tofloat()); //â©q
			change_appendage.addParameter(CHANGE_STATUS_TYPE_ELEMENT_ATTACK_DARK, false, value23.tofloat()); //äŞq
