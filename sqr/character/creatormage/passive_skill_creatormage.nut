...
function ProcPassiveSkill_CreatorMage(obj, skill_index, skill_level)
{
	...
	else if (skill_index == 70)
	{
		if(skill_level > 0)
		{
			local appendage = CNSquirrelAppendage.sq_AppendAppendage(obj, obj, skill_index, false, "character/creatormage/huanxin/ap_latentability.nut", true);
		}
	}
	return true;
}
